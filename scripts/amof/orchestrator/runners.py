...
PACKAGED_CODE_RUNNER_PROMPT = (
    ...
    "metadata; never request arbitrary shell. ToolProposal proposals must keep "
    "timeout_seconds within 1..120, keep allowed_paths narrow and workspace-relative, "
    "and use a read-only bash or Python script only. "

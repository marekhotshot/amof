...
_COMMAND_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "cmd_ticket_preflight": ("ticket", "cmd_ticket_preflight"),
    "cmd_ticket_start": ("ticket", "cmd_ticket_start"),
    "cmd_ticket_list": ("ticket", "cmd_ticket_list"),
    "cmd_ticket_status": ("ticket", "cmd_ticket_status"),
    "cmd_ticket_checkpoint": ("ticket", "cmd_ticket_checkpoint"),

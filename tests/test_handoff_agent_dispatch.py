    ...
    def test_explicit_hermes_result_preserves_structured_write_scope_proposal(
        ...
        def _fake_hermes(**kwargs: object) -> dict[str, object]:
            ...
            return {
                ...
                "write_scope_proposal": {
                    "scope_id": "documentation-only-bounded-write-scope-docs-launch-readiness-simple-ai-shop-launch-readiness-md-67f8526b",
        ...
        with TemporaryDirectory(
            ...
            self.assertEqual(
                ...
                "documentation-only-bounded-write-scope-docs-launch-readiness-simple-ai-shop-launch-readiness-md-67f8526b",
            )

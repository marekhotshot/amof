...
Install the public v3.0.3 release:
...
AMOF v3.0.3 also resolves the adopted ecosystem through `amof context`; dotted
...
important v3.0.3 behavior is that the command reaches provider validation and
does not fail with:

...
Install the public v3.0.2 release:
...
AMOF v3.0.2 also resolves the adopted ecosystem through `amof context`; dotted
...
important v3.0.2 behavior is that the command reaches provider validation and
does not fail with:

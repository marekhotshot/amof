...
- [examples/authority-ledger-bounded-action.example.json](examples/authority-ledger-bounded-action.example.json)
- [examples/authority-ledger-refuse.example.json](examples/authority-ledger-refuse.example.json)
- [examples/intake-authority-evaluation-bounded-action.example.json](examples/intake-authority-evaluation-bounded-action.example.json)
- [examples/runner-authority-gating-bounded-match.example.json](examples/runner-authority-gating-bounded-match.example.json)

...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/release-v2.6.3-0A7FFF.svg" alt="release v2.6.3" />
  <img src="https://img.shields.io/badge/python-3.11%2B-3776AB.svg" alt="Python 3.11+" />
</p>

AMOF v2.6.3 is a local-first CLI for adopting a repo into an evidence-first
...
This public `main` intentionally keeps a narrow, installable v2.6.3 surface:
...
```bash
pipx install "git+https://github.com/marekhotshot/amof.git@v2.6.3"
```
...
AMOF v2.6.3 includes a public default `code` runner for bounded
...
- `v2.6.3` is the current public release candidate target for this slice.
